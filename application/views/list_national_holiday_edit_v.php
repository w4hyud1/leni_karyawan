<div class="container-fluid">
	...
	<div class="card mb-4">
		<div class="card-header"><i class="fas fa-table mr-1"></i>New National Holiday</div>
		<div class="card-body">
			<form action="<?php echo base_url()?>list_national_holiday/update" method="POST">
            <!-- <input type="hidden" name="id"  > -->
				<div class="form-row">
					<input type="hidden" name="id" value="<?php echo $get_data['id'];?>">
					<div class="col-md-6 mb-6">
						<label for="validationDefault01">Name Holiday</label>
						<input type="text" name="name" class="form-control" id="validationDefault01" placeholder="Name" value="<?php echo $get_data['name_holiday'];?>" >
					</div>
					<div class="col-md-6 mb-6">
