...
<html lang="en">
    ...
    <body class="bg-primary">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                ...
                                <?= $this->session->flashdata('message'); ?>
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Cuti</h3></div>
                                    ...
                                    <div class="card-body">
                                        <form action="<?=base_url()."cuti/save"?>" method="POST">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group"><label class="small mb-1" for="inputLastName">Count Cuti Tahunan</label>
                                                        <input class="form-control py-4" type="text" id="count_cuti" name="count_cuti" value="<?php echo $count_cuti->cuti?>" readonly/>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Activity</label>
                                                        <select name="activity" id="activity" class="form-control py">
                                                            <?php
                                                                foreach ($list_cuti as $row) {
                                                                    echo "<option value='$row->name'>$row->name - $row->count_cuti</option>";
                                                                }
                                                            ?>
                                                        </select>
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><a>History Cuti</a></div>
                                        <div class="small">
        ...
        <script type="text/javascript">
            ...
            var activity_fromfield = $('#activity').val();
            $.ajax({
                method: "POST",      
                url: "ajaxrespon.php",   
                data: { id: activity_fromfield}
            })
                .done(function( hasilajax ) { 
                    $('#count_cuti').val(hasilajax);
                });
            })
            });
        </script>
